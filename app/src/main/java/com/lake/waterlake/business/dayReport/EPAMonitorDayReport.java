 ...
 *
 */
public class EPAMonitorDayReport extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.epa_monitor_dayreport);
    ...
    public  void initData(String reportid) {
        ...
        List<RequestParameter>    parameters =
                WSFunction.getParameters(ApplicationGlobal.WSSessionId, "waterLake.epamonitor",params, Conditions);
